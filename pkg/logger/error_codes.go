...
const (
	...
	ErrCodeConfig            Code = "1800" // General configuration error
	ErrCodeConfigMissing     Code = "1801" // Missing configuration
	ErrCodeConfigInvalid     Code = "1802" // Invalid configuration value
	ErrCodeConfigType        Code = "1803" // Configuration type mismatch
	ErrCodeConfigFile        Code = "1804" // Configuration file error
	ErrCodeConfigEnvironment Code = "1805" // Environment configuration error
	ErrCodeConfigOverride    Code = "1806" // Configuration override error
	ErrCodeConfigDependency  Code = "1807" // Configuration dependency error
)
...
var CodeDetails = map[Code]string{
	...
	ErrCodeConfig:            "General configuration error",
	ErrCodeConfigMissing:     "Missing configuration parameter",
	ErrCodeConfigInvalid:     "Invalid configuration value",
	ErrCodeConfigType:        "Configuration type mismatch",
	ErrCodeConfigFile:        "Configuration file error",
	ErrCodeConfigEnvironment: "Environment configuration error",
	ErrCodeConfigOverride:    "Configuration override error",
	ErrCodeConfigDependency:  "Configuration dependency error",
}
